...
public class Tetromino
{
    ...
    private static final Map<Shape, int[][]> SHAPE_COORD_MAP = Map.ofEntries(
            ...
            Map.entry(Shape.shapeO, new int[][]{{0, 1}, {0, 0}, {1, 0}, {1, 1}}),
            Map.entry(Shape.shapeT, new int[][]{{-1, 1}, {0, 0}, {1, 1}, {0, 1}}),
...
//            currentCells[i].setCoordX(coords[i][0]);
//            currentCells[i].setCoordY(coords[i][1]);
        }
    }
